                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 col-xl-3">
                        <div className="card daily-sales">
                          <div className="card-block">
                            <h6 className="mb-4">Ongoing Matters</h6>
                            <div className="row d-flex align-items-center">
                              <div className="col-9">
                                <h3 className="f-w-300 d-flex align-items-center m-b-0">
                                  <i
                                      className="feather icon-arrow-up text-c-green f-30 m-r-10"
                                  ></i
                                  >18
                                </h3>
                              </div>
                              ...
                              <div className="col-10 text-left pt-2">
                                <p className="m-b-0">+ 7% compared to average</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="col-md-6 col-xl-3">
                        <div className="card Monthly-sales">
                          <div className="card-block">
                            <h6 className="mb-4">Matters closed this Month</h6>
                            <div className="row d-flex align-items-center">
                              <div className="col-9">
                                <h3 className="f-w-300 d-flex align-items-center m-b-0">
                                  <i
                                      className="feather icon-arrow-down text-c-red f-30 m-r-10"
                                  ></i
                                  >5
                                </h3>
                              </div>
                              <div className="col-10 text-left pt-2">
                                <p className="m-b-0">- 6% compared to average</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="col-md-6 col-xl-3">
                        <div className="card Monthly-sales">
                          <div className="card-block">
                            <h6 className="mb-4">Avg. Matters per Lawyer</h6>
                            <div className="row d-flex align-items-center">
                              <div className="col-9">
                                <h3 className="f-w-300 d-flex align-items-center m-b-0">
                                  <i
                      ...
                      <div className="col-md-6 col-xl-3">
                        <div className="card Monthly-sales">
                          <div className="card-block">
                            <h6 className="mb-4">Expenses this month</h6>
                            <div className="row d-flex align-items-center">
                              <div className="col-9">
                                <h3 className="f-w-300 d-flex align-items-center m-b-0">
                                  <i
                              ...
                              <div className="col-10 text-left pt-2">
                                <p className="m-b-0">+ 3% compared to average</p>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="card-block border-bottom">
                            <div className="row d-flex align-items-center">
                              <div className="col-auto">
                                <i
                                    className="feather icon-user-plus f-30 text-c-green"
                                ></i>
                              </div>
                              <div className="col">
                                <h3 className="f-w-300">12</h3>
                                <span className="d-block text-uppercase"
                                >Cases requiring external help</span
                                >
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="col-xl-3 col-md-6">
                        <div className="card">
                          <div className="card-block border-bottom">
                            <div className="row d-flex align-items-center">
                              <div className="col-auto">
                                <i className="feather icon-watch f-30 text-c-green"></i>
                              </div>
                              <div className="col">
                                <h3 className="f-w-300">17 Days</h3>
                                <span className="d-block text-uppercase"
                                >Average Turnaround time</span
                                >
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="col-xl-3 col-md-6">
                        <div className="card">
                          <div className="card-block">
                            <div className="row d-flex align-items-center">
                              <div className="col-auto">
                                <i className="feather icon-zap f-30 text-c-blue"></i>
                              </div>
                              <div className="col">
                                <h3 className="f-w-300">€ 2.600</h3>
                                <span className="d-block text-uppercase"
                                >Average Spend on Case</span
                                >
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="card">
                          <div className="card-block">
                            <div className="row d-flex align-items-center">
                              <div className="col-auto">
                                <i
                                    className="feather icon-check-square f-30 text-c-blue"
                                ></i>
                              </div>
                              <div className="col">
                                <h3 className="f-w-300">577</h3>
                                <span className="d-block text-uppercase"
                                >Total matters resolved</span
                                >
                              </div>
                            </div>
                          </div>
                              ...
                              <table className="table table-hover">
                                ...
                                <tr className="unread">
                                  <td>
                                    ...
                                    <p className="m-0">Lawsuit about something</p>
                                  </td>
                                  <td>
                                ...
                                <tr className="unread">
                                  <td>
                                    ...
                                    <p className="m-0">Parking fees negotiation</p>
                                  </td>
                                  <td>
                                    <h6 className="text-muted">
                            ...
                            >
                              <div className="col-6">
                                ...
                                >
                                  3.75
                                  <i
                                      className="fas fa-star f-10 m-l-10 text-c-yellow"
                                  ></i>
                                </h2>
                              </div>
                              <div className="col-6">
                                ...
                                >
                                  + 0.4 %
                                  <i
                                      className="fas fa-caret-up text-c-green f-22 m-l-10"
                                  ></i>
                                </h6>
                              </div>
                            </div>
                            <div className="row">
                              <div className="col-xl-12">
                                <h6 className="align-items-center float-left">
                                  <i
                                      className="fas fa-star f-10 m-r-10 text-c-yellow"
                                  ></i
                                  >5
                                </h6>
